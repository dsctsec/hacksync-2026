...
//     >
//       {/* Background: Brick Wall Crime Scene */}
//       <div className="absolute inset-0 bg-[#1a1a1a]">
//         {/* Brick Wall Texture */}
//         <div className="absolute inset-0 opacity-30 bg-[url('https://www.transparenttextures.com/patterns/brick-wall.png')]" />
...
//         <div className="absolute top-[15%] left-0 right-0 h-12 bg-yellow-400 opacity-20 transform -rotate-3 z-0" 
//              style={{ 
//                backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(0,0,0,0.3) 35px, rgba(0,0,0,0.3) 70px)' 
//              }}
//         />
//         <div className="absolute bottom-[25%] left-0 right-0 h-12 bg-yellow-400 opacity-20 transform rotate-2 z-0"
//              style={{ 
//                backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(0,0,0,0.3) 35px, rgba(0,0,0,0.3) 70px)' 
//              }}
//         />
